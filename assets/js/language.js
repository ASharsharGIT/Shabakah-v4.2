...
function updateAboutPage(about) {
    ...
    const vmTranslations = currentLanguage === 'ar' ? [
        ...
        {
            title: 'Our Mission',
            desc: 'To deliver cutting-edge ICT and ISP solutions that empower organizations to achieve their goals through secure, reliable, and future-ready infrastructure.'
        }
    ];
